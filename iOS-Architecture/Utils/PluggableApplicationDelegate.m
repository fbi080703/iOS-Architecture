...
@implementation PluggableApplicationDelegate

- (void)applicationDidFinishLaunching:(UIApplication *)application{
    
    for (id<ApplicationService> service in self.services) {
        
        //[service respondsToSelector:@selector(applicationDidFinishLaunching:)]
...
- (BOOL)application:(UIApplication *)application willFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    for (id<ApplicationService>service in self.services) {
        ...
        //[service respondsToSelector:@selector(application:willFinishLaunchingWithOptions:)]
        if ([service respondsToSelector:_cmd]) {
            
            return [service application:application willFinishLaunchingWithOptions:launchOptions];
        }
    }
    return YES;
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    for (id<ApplicationService>service in self.services) {
        ...
        //[service respondsToSelector:@selector(application:didFinishLaunchingWithOptions:)]
        if ([service respondsToSelector:_cmd]) {
...
- (void)applicationDidBecomeActive:(UIApplication *)application{
    ...
    for (id<ApplicationService> service in self.services) {
        ...
        //[service respondsToSelector:@selector(applicationDidBecomeActive:)]
        if ([service respondsToSelector:_cmd]) {
...
- (void)applicationWillResignActive:(UIApplication *)application{
    ...
    for (id<ApplicationService> service in self.services) {
        ...
        //[service respondsToSelector:@selector(applicationWillResignActive:)]
        if ([service respondsToSelector:_cmd]) {
...
- (void)applicationDidReceiveMemoryWarning:(UIApplication *)application{
    ...
    for (id<ApplicationService> service in self.services) {
        ...
        //[service respondsToSelector:@selector(applicationDidReceiveMemoryWarning:)]
        if ([service respondsToSelector:_cmd]) {
...
- (void)applicationWillTerminate:(UIApplication *)application{
    ...
    for (id<ApplicationService> service in self.services) {
        ...
        //[service respondsToSelector:@selector(applicationWillTerminate:)]
        if ([service respondsToSelector:_cmd]) {
...
- (void)applicationSignificantTimeChange:(UIApplication *)application{
    ...
    for (id<ApplicationService> service in self.services) {
        ...
        //[service respondsToSelector:@selector(applicationSignificantTimeChange:)]
        if ([service respondsToSelector:_cmd]) {
...
- (void)applicationDidEnterBackground:(UIApplication *)application{
    ...
    for (id<ApplicationService> service in self.services) {
        ...
        //[service respondsToSelector:@selector(applicationDidEnterBackground:)]
        if ([service respondsToSelector:_cmd]) {
...
- (void)applicationWillEnterForeground:(UIApplication *)application{
    ...
    for (id<ApplicationService> service in self.services) {
        //[service respondsToSelector:@selector(applicationWillEnterForeground:)]
        if ([service respondsToSelector:_cmd]) {
